...
[Mesh]
  ...
  [cluster34]
    ...
    file = 'twoFractures_Intersect.exo'
    # file = 'Cluster_34.exo'
  []
  [injection_node]
    type = BoundingBoxNodeSetGenerator
    input = cluster34
    bottom_left = '49 58 63'
    top_right = '50 59 64'
...
[DiracKernels]
  [inject_fluid]
    ...
    point = '4.945820809E+01   5.894770257E+01   6.310974101E+01'
    variable = frac_P
  []
  [withdraw_fluid]
...
[Postprocessors]
  ...
  [TK_out]
    type = PointValue
    variable = frac_T
    point = '1.195263842E+02   1.153789246E+02   8.507414129E+01' # Node         318   1.195263842E+02   1.153789246E+02   8.507414129E+01
  []
  [P_out]
    type = PointValue
    variable = frac_P
    point = '1.195263842E+02   1.153789246E+02   8.507414129E+01'
  []
  [P_in]
    type = PointValue
    variable = frac_P
    point = '4.945820809E+01   5.894770257E+01   6.310974101E+01' # Node         183   4.945820809E+01   5.894770257E+01   6.310974101E+01
  []
[]
